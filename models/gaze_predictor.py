...
class UNet(nn.Module):
    def __init__(self, input_channels):
        ...
        self.upconv3 = nn.ConvTranspose2d(32, 16, kernel_size=2, stride=2, output_padding = (1,1))
...
if __name__ == '__main__':
    input_channels = 3  # For example, stack_number can be 3
    model = UNet(input_channels).to('cuda')  # Fixed output channels (e.g., 1)

    # Input tensor of shape (batch_size, input_channels, 84, 84)
    input_tensor = torch.randn(128, input_channels, 84, 84).to('cuda')
